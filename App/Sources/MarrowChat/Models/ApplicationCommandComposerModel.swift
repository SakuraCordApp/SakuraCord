...
final class ApplicationCommandComposerModel {
    ...
    @ObservationIgnored private var frecencyDefaultsKey = "dev.marrowchat.command-frecency.offline"
    ...
    func configureFrecencyScope(_ scope: String) {
        ...
        frecencyDefaultsKey = "dev.marrowchat.command-frecency.\(safeScope)"
