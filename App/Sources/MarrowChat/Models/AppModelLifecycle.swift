...
extension AppModel {
            ...
            let preferredPerformanceAccountID =
                runsChatPerformanceBenchmark
                    ? ProcessInfo.processInfo.environment[
                        "MARROWCHAT_PERFORMANCE_ACCOUNT_ID"
                    ]
                    : nil
    ...
    func applyEmojiUpdate(
        ...
        guard let existing = emojisByGuild[guildID] else {
            ...
            // MarrowChat deliberately leaves this guild unresolved so the existing
    ...
    func recordEmojiUse(_ key: String) {
        ...
        if persistsEmojiPreferences {
            UserDefaults.standard.set(emojiUsageCounts, forKey: "dev.marrowchat.emoji-usage")
        }
    }
    ...
    func toggleFavoriteEmoji(_ key: String) {
        ...
        if persistsEmojiPreferences {
            UserDefaults.standard.set(
                Array(favoriteEmojiKeys), forKey: "dev.marrowchat.favorite-emojis")
        }
    }
    ...
    extension AppModel {
        ...
        private func writeAuthenticatedHistoryPaginationBenchmarkResult(
            ...
            guard let path = ProcessInfo.processInfo.environment[
                "MARROWCHAT_PERFORMANCE_RESULT_PATH"
            ] else { return }
            let contents = """
            outcome\t\(outcome)
        ...
        private func writeAuthenticatedScrollInteractionBenchmarkResult(
            ...
            surface\t\(ProcessInfo.processInfo.environment["MARROWCHAT_PERFORMANCE_SCROLL_SURFACE"] ?? "all")
