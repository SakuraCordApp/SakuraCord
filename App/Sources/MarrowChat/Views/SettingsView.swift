        ...
        TabView {
            Form {
                ...
                Section("Software updates") {
                    ...
                    .disabled(!updateController.isEnabled)
                    .accessibilityHint(
                        "Uses MarrowChat’s signed update feed on the configured schedule."
                    )
                ...
                Section("Discord API logs") {
                    ...
                    Text(
                        "Exports retained Discord REST, attachment, authentication, and Gateway request/response metadata from this app session. "
                            ...
                            + "Disk capture is off by default and keeps at most four private JSON Lines session files of up to 64 MiB each in Application Support/MarrowChat/Diagnostics."
                    )
                    .font(.caption)
                    .foregroundStyle(.secondary)
