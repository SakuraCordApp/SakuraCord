...
struct MarrowChatSessionLoadingView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Opening MarrowChat. \(detail)")
    }
...
struct MarrowChatAuroraBackdrop: View {
...
struct MarrowChatSakuraPetalField: View {
    let elapsed: TimeInterval
    let size: CGSize
