        ...
        ZStack {
            GeometryReader { geometry in
                TimelineView(.animation(minimumInterval: 1.0 / 30.0, paused: reduceMotion)) { timeline in
                    ...
                    ZStack {
                        MarrowChatAuroraBackdrop(elapsed: elapsed)
                        MarrowChatSakuraPetalField(elapsed: elapsed, size: geometry.size)
            ...
            if showsCancel {
                MarrowChatAuthenticationCloseButton { dismiss() }
                .padding(20)
...
struct MarrowChatAuthenticationCard<Content: View>: View {
...
struct MarrowChatAuthenticationCloseButton: View {
    let action: () -> Void
...
struct MarrowChatAuthPrimaryButtonStyle: ButtonStyle {
...
private struct DiscordCredentialForm: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            .buttonStyle(MarrowChatAuthPrimaryButtonStyle())
