...
actor UserDefaultsDiscordFingerprintStore: DiscordFingerprintStoring {
    ...
    private nonisolated static let key = "dev.marrowchat.discord-fingerprint"
    private nonisolated static let installationKey = "dev.marrowchat.discord-installation-id"
...
nonisolated enum AuthenticationError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .captchaRequired: "Discord returned another CAPTCHA challenge after completion, so MarrowChat stopped without replaying again."
        ...
        case .accountRestricted: "Discord returned an account restriction, verification, or authorization stop. MarrowChat will not retry this session."
        case .unsupportedMFA: "This account requires an MFA method MarrowChat cannot complete natively. Use the official Discord client."
        case .rejected: "Discord rejected the new account session. MarrowChat stopped without retrying."
        case .invalidResponse: "Discord returned an invalid sign-in response. MarrowChat stopped without retrying."
