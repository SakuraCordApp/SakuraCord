...
actor DiscordRemoteAuthManager {
    ...
    func connect() async {
        ...
        do {
            ...
            emit(.failed("MarrowChat could not create a private QR sign-in session."))
        }
    }
...
nonisolated enum DiscordRemoteAuthError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .keyGenerationFailed: "MarrowChat could not create the private key for QR sign-in."
