...
@main
struct MarrowChatApp: App {
    @NSApplicationDelegateAdaptor(AppDelegate.self) private var appDelegate
    @AppStorage(AppearanceMode.preferenceKey) private var appearanceMode = AppearanceMode.system
    ...
    var body: some Scene {
        // MarrowChat owns one account workspace. A WindowGroup would restore
        // every previously opened main window on the next launch.
        Window("MarrowChat", id: "main") {
            RootView(model: model)
                ...
                .task {
                    ...
                    if activatesAuthenticatedScrollBenchmark {
                        ...
                        // scheduling as MarrowChat frame loss.
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let notificationCenterDelegate = MarrowChatNotificationCenterDelegate()
...
final class MarrowChatNotificationCenterDelegate: NSObject {}

extension MarrowChatNotificationCenterDelegate: UNUserNotificationCenterDelegate {
    ...
    nonisolated func userNotificationCenter(
        ...
        await MainActor.run {
            ...
            NotificationCenter.default.post(
                name: .marrowchatNotificationDeepLink,
                object: link
            )
        }
    }
