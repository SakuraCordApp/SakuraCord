...
struct MarrowChatCommands: Commands {
    let model: AppModel
    ...
    var body: some Commands {
        ...
        CommandMenu("Navigate") {
            ...
            Button("Toggle Member Inspector") { NotificationCenter.default.post(name: .marrowchatToggleInspector, object: nil) }
                .keyboardShortcut("i", modifiers: [.command, .option])
            Button("Focus Composer") { NotificationCenter.default.post(name: .marrowchatFocusComposer, object: nil) }
