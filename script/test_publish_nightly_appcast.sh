...
printf '%s\n' \
  ...
  '    <enclosure url="https://github.com/SakuraCordApp/SakuraCord/releases/download/v0.2.0-nightly.3/SakuraCord.v0.2.0-nightly.3.dmg" />' \
  '  </item></channel>' \
  '</rss>' > "$APPCAST"
...
GITHUB_REPOSITORY=SakuraCordApp/SakuraCord \
GITHUB_RUN_ID=123 \
SAKURACORD_RELEASE_TAG=v0.2.0-nightly.3 \
