...
struct GatewayFeatureIdentifierDTO: Decodable {
    var id: StringOrIntegerDTO?
    var guildID: String?
    var channelID: String?
    var userID: String?
    var soundID: StringOrIntegerDTO?
    var ruleID: StringOrIntegerDTO?
    var messageID: StringOrIntegerDTO?
    var scheduledEventID: StringOrIntegerDTO?
    var answerID: StringOrIntegerDTO?
    var applicationID: StringOrIntegerDTO?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case scheduledEventID = "guild_scheduled_event_id"
        case answerID = "answer_id"
        case applicationID = "application_id"
    }

    var entityID: String? {
        id?.value ?? soundID?.value ?? ruleID?.value ?? scheduledEventID?.value
            ?? messageID?.value
    }

    var relatedID: String? {
        answerID?.value ?? applicationID?.value
    }
}
